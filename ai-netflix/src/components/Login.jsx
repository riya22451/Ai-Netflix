...
const Login = () => {
  ...
  return (
    <div>
        ...
        <form className='p-12 bg-black/70 absolute  w-3/12 mt-36 mx-auto left-0 right-0 text-white flex flex-col'> 
        <h1 className='font-bold text-3xl my-4 '>{signIn ? "Sign In" : "Sign Up"}</h1>
            ...
            <input type="text" placeholder="Email Address" className='p-4 my-4 border border-gray-50 w-full'/>
              <input type="text" placeholder="Password" className='p-4 my-4  border border-gray-50 w-full'/>
              <button className='bg-red-600 p-4 m-2 rounded-sm my-4 w-full'>{signIn ? "Sign In" : "Sign Up"}</button>
